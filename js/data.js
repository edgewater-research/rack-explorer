...
const PRESETS = [
  {
    ...
    rack:{ compute_trays:18, xpus_per_tray:4, cpus_per_tray:2, boards_per_tray:2, switch_trays:9, switch_chips_per_tray:2,
           switch_chips_per_compute_tray:0, nics_per_xpu:1, dpus_per_tray:2, drives_per_tray:4, mgmt_ports_per_tray:1, rack_u:48, power_kw:120, cooling:'Direct liquid (cold plates)', form:'Oberon (MGX) rack' },
  ...
  },
  {
    ...
    rack:{ compute_trays:18, xpus_per_tray:4, cpus_per_tray:2, boards_per_tray:2, switch_trays:9, switch_chips_per_tray:2,
           switch_chips_per_compute_tray:0, nics_per_xpu:1, dpus_per_tray:2, drives_per_tray:4, mgmt_ports_per_tray:1, rack_u:48, power_kw:135, cooling:'Direct liquid (cold plates)', form:'Oberon (MGX) rack' },
    scaleup:{ name:'NVLink 5', topology:'switched', links_per_xpu:18, lanes_per_link:2, lane_gbps:200, sw:'nvsw5',
              media_xpu_sw:'backplane', media_tray_tray:'backplane', vendor_bidir_tbs:1.8 },
    scaleout:{ nic_media:'pluggable', module_gbps:800, so_sw:'qx800', dpu_media:'pluggable', oversub:1 },
  ...
  },
  {
    ...
    rack:{ compute_trays:18, xpus_per_tray:4, cpus_per_tray:2, boards_per_tray:2, switch_trays:9, switch_chips_per_tray:2,
           switch_chips_per_compute_tray:0, nics_per_xpu:1, dpus_per_tray:2, drives_per_tray:4, mgmt_ports_per_tray:1, rack_u:48, power_kw:190, cooling:'100% liquid', form:'Oberon (MGX) rack, cable-free trays' },
  ...
  },
  {
    ...
    rack:{ compute_trays:72, xpus_per_tray:2, cpus_per_tray:1, boards_per_tray:1, switch_trays:18, switch_chips_per_tray:2,
           switch_chips_per_compute_tray:0, nics_per_xpu:2, dpus_per_tray:1, drives_per_tray:2, mgmt_ports_per_tray:1, rack_u:60, power_kw:600, cooling:'100% liquid', form:'Kyber rack: vertical blades, 4 pods × 18' },
  ...
  },
  {
    ...
    rack:{ compute_trays:4, xpus_per_tray:8, cpus_per_tray:2, boards_per_tray:1, switch_trays:0, switch_chips_per_tray:0,
           switch_chips_per_compute_tray:2, nics_per_xpu:1, dpus_per_tray:2, drives_per_tray:8, mgmt_ports_per_tray:1, rack_u:42, power_kw:60, cooling:'Air (or hybrid)', form:'8–10U HGX servers' },
  ...
  },
  {
    ...
    rack:{ compute_trays:4, xpus_per_tray:16, cpus_per_tray:2, boards_per_tray:2, switch_trays:0, switch_chips_per_tray:0,
           switch_chips_per_compute_tray:0, nics_per_xpu:0.5, dpus_per_tray:2, drives_per_tray:4, mgmt_ports_per_tray:1, rack_u:42, power_kw:45, cooling:'Air', form:'4 × 2U-class Trn2 servers' },
  ...
  },
  {
    ...
    rack:{ compute_trays:9, xpus_per_tray:16, cpus_per_tray:2, boards_per_tray:2, switch_trays:9, switch_chips_per_tray:2,
           switch_chips_per_compute_tray:0, nics_per_xpu:0.5, dpus_per_tray:2, drives_per_tray:4, mgmt_ports_per_tray:1, rack_u:48, power_kw:150, cooling:'Liquid', form:'Multi-rack UltraServer (placeholder layout)' },
  ...
  },
  {
    ...
    rack:{ compute_trays:16, xpus_per_tray:4, cpus_per_tray:1, boards_per_tray:1, switch_trays:0, switch_chips_per_tray:0,
           switch_chips_per_compute_tray:0, nics_per_xpu:0.5, dpus_per_tray:0, drives_per_tray:0, mgmt_ports_per_tray:1, rack_u:42, power_kw:80, cooling:'Liquid', form:'Google TPU rack, 64 chips' },
  ...
  },
  {
    ...
    rack:{ compute_trays:18, xpus_per_tray:4, cpus_per_tray:1, boards_per_tray:1, switch_trays:9, switch_chips_per_tray:2,
           switch_chips_per_compute_tray:0, nics_per_xpu:3, dpus_per_tray:0, drives_per_tray:4, mgmt_ports_per_tray:1, rack_u:48, power_kw:200, cooling:'Liquid', form:'Double-wide OCP rack' },
  ...
  },
  {
    ...
    rack:{ compute_trays:4, xpus_per_tray:8, cpus_per_tray:2, boards_per_tray:1, switch_trays:0, switch_chips_per_tray:0,
           switch_chips_per_compute_tray:0, nics_per_xpu:1, dpus_per_tray:0, drives_per_tray:8, mgmt_ports_per_tray:1, rack_u:42, power_kw:60, cooling:'Air or liquid', form:'8–10U UBB servers' },
